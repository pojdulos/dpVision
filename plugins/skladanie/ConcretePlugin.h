...
#include "icpPointToPoint.h"
    ...
    #undef PLUGIN_NAME
#endif 
#define PLUGIN_NAME L"(dp) skladanie"
...
class PLUGINDLL_API ConcretePlugin : public Plugin
{
	...
	QVector<CMesh*> shells;
	QMap<QString, CAnnotationPoint*> points;

	CModel3D* objRuchomy, * objNieruchomy;
...
public:
	...
	void showShellLine(int shellIdx);

	void showPointLine(QString ptLabel);
