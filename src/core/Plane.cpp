...
// dzieli kwadratowe oczka na dwa tr�jk�ty
...
// dieli kwadratowe oczka na cztery tr�jk�ty dodaj�c wierzcho�ek w �rodku
	...
	const CPoint3d& bottomLeft, const CPoint3d& bottomRight, int divisions )
{
	...
	// Dodanie dodatkowych wierzcho�k�w w �rodkach kwadrat�w
	...
	for (int i = 0; i < divisions; ++i) {
		for (int j = 0; j < divisions; ++j) {
			...
			// Dzielenie kwadratu na cztery tr�jk�ty
...
// 	// Sk�adniki macierzy sko�nosymetrycznej
