...
#ifdef DPVISION_LEGACY_API_STATIC
#  define DPVISION_LEGACY_API_EXPORT
#elif defined(DPVISION_LEGACY_API_BUILD)
#  define DPVISION_LEGACY_API_EXPORT DP_DECL_EXPORT
#else
#  define DPVISION_LEGACY_API_EXPORT DP_DECL_IMPORT
#endif
