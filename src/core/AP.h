...
namespace AP
{
    ...
    namespace WORKSPACE {
         ...
         * @return True if removal was successful
         */
        DPVISION_EXPORT bool removeImage(int id);
         ...
         * @return True if removal was successful
         */
        DPVISION_EXPORT bool removeImage(std::shared_ptr<CImage> im);
        ...
        namespace SELECTION {
             ...
             */
            DPVISION_EXPORT std::list<int> getList(std::set<CBaseObject::Type> types, std::shared_ptr<CObject> obj = nullptr);
