...
//	{
//		doneCurrent();
//		// Obs�uga b��du - mo�e by� rzut wyj�tku lub zwr�cenie punktu z warto�ciami wskazuj�cymi na b��d
...
bool GLViewer::inTriangle(CPoint3d pt, CPoint3d pA, CPoint3d pB, CPoint3d pC)
{
	...
	// --------------------------------------------------------------
	// sprawdzam czy pIntersectionPoint lezy w tr�jk�cie tFace
	// --------------------------------------------------------------
	...
	if (s < 0.0 || s > 1.0)         // pIntersectionPoint le�y poza tr�jk�tem
		return false;

	double t = (uv * wu - uu * wv) / D;

	if (t < 0.0 || (s + t) > 1.0)  // pIntersectionPoint le�y poza tr�jk�tem
		return false;

	return true; // pIntersectionPoint le�y na tr�jk�cie tFace
}
